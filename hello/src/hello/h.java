...
public class h {
	 ...
	 {
		 System.out.print("\n2.showDirctedGraph\n");       
		 GraphViz gViz=new GraphViz("C:\\", "C:\\Graphviz\\bin\\dot.exe");
		        gViz.start_graph();
		       // gViz.addln("A->B;");
		        for(int i=0;i<vlen;i++)
		        {
	...
	{
		BufferedReader inFile = new BufferedReader(new FileReader("D:\\example.txt"));
		String str = "";
		String result = "";
		...
		result = result.replaceAll("[^A-Za-z., \n?!:;¡ª_(){}\"\'-]","").replaceAll("[^A-Za-z]"," ").replaceAll(" +"," ").toLowerCase();
		String[] arrays;
		arrays = result.split(" ");
